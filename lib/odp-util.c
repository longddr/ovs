...
tunnel_key_attr_len(int type)
{
    ...
    case OVS_TUNNEL_KEY_ATTR_NSH_C1: return 4;
    case OVS_TUNNEL_KEY_ATTR_NSH_C2: return 4;
    case OVS_TUNNEL_KEY_ATTR_NSH_C3: return 4;
    case OVS_TUNNEL_KEY_ATTR_NSH_C4: return 4;
    ...
    case OVS_KEY_ATTR_TUNNEL:
        ...
        if (odp_tun_key_from_attr(a, &tun_key) == ODP_FIT_ERROR) {
            ...
            ds_put_format(ds, "tun_id=%#"PRIx64"/%#"PRIx64
                          ...
                          ntohl(tun_key.nshc1), ntohl(tun_mask.nshc1),
                          ntohl(tun_key.nshc2), ntohl(tun_mask.nshc2),
                          ntohl(tun_key.nshc3), ntohl(tun_mask.nshc3),
                          ntohl(tun_key.nshc4), ntohl(tun_mask.nshc4),
            ...
            */
            ...
            ds_put_format(ds, "tun_id=0x%"PRIx64",nsp=0x%"PRIx32",nsi=%"PRIu8
                          ",nshc1=0x%"PRIx32",nshc2=0x%"PRIx32
                          ",nshc3=0x%"PRIx32",nshc4=0x%"PRIx32
                          ",src="IP_FMT",dst="IP_FMT","
                          "tos=0x%"PRIx8",ttl=%"PRIu8",flags(",
                          ntohll(tun_key.tun_id),
                          ntohl(tun_key.nsp), tun_key.nsi,
                          ntohl(tun_key.nshc1), ntohl(tun_key.nshc2),
                          ntohl(tun_key.nshc3), ntohl(tun_key.nshc4),
                        ...
                        struct ofpbuf *key, struct ofpbuf *mask)
{
...

    {
        ...
        uint32_t nshc1, nshc1_mask;
        uint32_t nshc2, nshc2_mask;
        uint32_t nshc3, nshc3_mask;
        uint32_t nshc4, nshc4_mask;
        int n = -1;

        if (mask && ovs_scan(s, "tunnel(tun_id=%"SCNi64"/%"SCNi64","
                             "nsp=%"PRIx32"/%"PRIx32",nsi=%"SCNi8"/%"SCNi8","
                             "nshc1=%"PRIx32"/%"PRIx32",nshc2=%"PRIx32"/%"PRIx32","
                             "nshc3=%"PRIx32"/%"PRIx32",nshc4=%"PRIx32"/%"PRIx32","
                             ...
                             &nshc1, &nshc1_mask, &nshc2, &nshc2_mask,
                             &nshc3, &nshc3_mask, &nshc4, &nshc4_mask,
            ...
            tun_key.nshc1 = htonl(nshc1);
            tun_key_mask.nshc1 = htonl(nshc1_mask);
            tun_key.nshc2 = htonl(nshc2);
            tun_key_mask.nshc2 = htonl(nshc2_mask);
            tun_key.nshc3 = htonl(nshc3);
            tun_key_mask.nshc3 = htonl(nshc3_mask);
            tun_key.nshc4 = htonl(nshc4);
            tun_key_mask.nshc4 = htonl(nshc4_mask);
            ...
            return n;
                            ...
                            "nshc1=%"PRIx32",nshc2=%"PRIx32","
                            "nshc3=%"PRIx32",nshc4=%"PRIx32","
